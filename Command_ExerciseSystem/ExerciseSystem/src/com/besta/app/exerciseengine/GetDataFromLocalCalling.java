...
//	private String G_count = "count";
	 ...
	 * @param context
	 */
	public GetDataFromLocalCalling(Context arg0)
	{
		context = arg0;
//		CallingBuffer = arg2;
	}
	public void getQuestion(String CallingBuffer)
	{
		try {
			JSONArray jsonNArray = new JSONArray(CallingBuffer);
			for(int i = 0;i<jsonNArray.length();i++)
			{
				JSONObject jsonObjectTemp_i = (JSONObject) jsonNArray.get(i);
				resolvingQuestion(jsonObjectTemp_i.toString(),0,false);
			}
