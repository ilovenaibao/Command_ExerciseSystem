...
public class LzmaAlone {
	static public class CommandLine {
		...
		public int DictionarySize = 1 << 15; // 1 << 23
	...
	public static void sevenZipUnzipMain(String[] args) throws Exception {
	...
	public static void main(String[] args) throws Exception {
		...
		// encode
		args[0] = "e";
		args[1] = "F:\\111\\decompress_pre.txt";
		args[2] = "F:\\111\\decompress.txt";

		// // decode
		// args[0] = "d";
		// args[1] = "F:\\111\\decompress.txt";
		// args[2] = "F:\\111\\unDecode.txt";
